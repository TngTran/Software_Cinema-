...
{
     internal class ThemXoaSua
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-42TS2U7;Initial Catalog=DB_RAPCHIEUPHIM;Integrated Security=True");//biến con sqlconection để kêt nối đến CSDL
